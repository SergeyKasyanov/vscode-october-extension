...
export class VersionDetector {
        ...
        for (const pkg of packages) {
            if (pkg.name === 'october/system') {
                if (pkg.version.includes('1.0.')) {
                    ...
                    return Version.oc36;
                } else if (pkg.version.includes('3.7.')) {
                    return Version.oc37;
                } else if (pkg.version.includes('4.0.')) {
                    return Version.oc40;
                } else if (pkg.version.includes('4.1.')) {
                    return Version.oc41;
                }
            }
        }
    ...
    private tryDetectByComposerJson(projectPath: string): Version | undefined {
        ...
        if (version.includes('1.0')) {
            ...
            return Version.oc36;
        } else if (version.includes('3.7')) {
            return Version.oc37;
        } else if (version.includes('4.0')) {
            return Version.oc40;
        } else if (version.includes('4.1')) {
            return Version.oc41;
        }
